...
<details align="center">
    <summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-danger">
        I year 
         </summary>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-primary" >1-1</summary>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >M1</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Physics</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >C Language</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Engineering Drawing</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="#" class="btn btn-default" >Unit2</a>
    <a href="#" class="btn btn-default" >Unit3</a>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >English</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-primary" >1-2</summary>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-primary" >M2</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="#" class="btn btn-default" >Unit2</a>
    <a href="#" class="btn btn-default" >Unit3</a>
    <a href="#" class="btn btn-default" >Unit4</a>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Chemistry</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Data Structures</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Environmental Studies</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >Professional English</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="#" class="btn btn-default" >Unit2</a>
    <a href="#" class="btn btn-default" >Unit3</a>
    <a href="#" class="btn btn-default" >Unit4</a>
...
<details align="center" style="margin-top:5px;">
    <summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-danger">II year </summary>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-primary" >2-1</summary>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >M3</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="#" class="btn btn-default" >Unit2</a>
    <a href="#" class="btn btn-default" >Unit3</a>
    <a href="#" class="btn btn-default" >Unit4</a>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >DM</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >DBMS</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >DLD</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="https://drive.google.com/uc?export=download&id=1wONtr-2hcbvaq_Ng5q9IGTlD1HP-zE6J" class="btn btn-default" >Unit2</a>
    <a href="https://drive.google.com/uc?export=download&id=1ByznSGimp_As5FdHhO4R1qeHLaBkl58g" class="btn btn-default" >Unit3</a>
    <a href="https://drive.google.com/uc?export=download&id=1-J6rIsKD6eBXrMRTFXbKdc8OQYT9AnfJ" class="btn btn-default" >Unit4</a>
    <a href="#" class="btn btn-default" >Unit5</a>
    </details>
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >MEFA</summary>
    <a href="#" class="btn btn-default" >Unit1</a>
    <a href="#" class="btn btn-default" >Unit2</a>
    <a href="#" class="btn btn-default" >Unit3</a>
    <a href="#" class="btn btn-default" >Unit4</a>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-success" >BEE</summary>
    ...
    <details><summary style="margin-top:4px;" style="margin-top:4px;" class="btn btn-primary" >2-2</summary>
...
<footer style="position:fixed;bottom:5px; width:100%; background-color:black; " align="center">
        ...
        <a href="https://www.facebook.com/BTAO-409913899565033" class="fa fa-facebook fa-2x social social-fb"></a>
