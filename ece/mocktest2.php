...
<html lang="en">
<head>
<title>Competitive mock test</title>
 <meta charset="utf-8">
...
<p style="text-align:center;">
  ...
  <a   style="margin-left:40%;" href="/ece/test1/mocktest1"type="button" class="btn btn-warning">test1</a><BR><br>
  <a   style="margin-left:40%;" href="/ece/test2/mocktest2" type="button" class="btn btn-success">test2</a><br><br>
  <a  style="margin-left:40%;" href="/ece/test3/mocktest3" type="button" class="btn btn-info">test3</a>
