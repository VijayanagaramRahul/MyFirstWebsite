  ...
  <div class="container-fluid">
    ...
    <li><a href="/civil/index">CIVIL</a></li>
      ...
      <ul class="nav navbar-nav navbar-right" style="margin-right:10%;">
        <li><a href="logout?vid"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
...
<div class='container-fluid R' align="center">
    <h3>Hi...! user you can can access your materials,syllabus copy and previous Question papers now...</h3>
</div>
    
        <li class="dropdown btn btn-primary" style="margin-left:30%; margin-top:5%;">
          <a class="dropdown-toggle" data-toggle="dropdown" style="color:white;" href="#">Materials<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="/cse/csematerial">CSE</a></li>
            <li><a href="/ece/ecematerial">ECE</a></li>
            <li><a href="/eee/eeematerial">EEE</a></li>
             <li><a href="/mech/mechmaterial">MECH</a></li>
              <li><a href="/civil/civilmaterial">CIV</a></li>
          </ul>
        </li>
