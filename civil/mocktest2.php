...
<html lang="en">
<head>
<title>Compititive mock test</title>
 <meta charset="utf-8">
...
<section>
  ...
  <div class="container" id="h" >
      <h2 class="heading" style="top:-10px; color:#005580;font-family:Cursive; text-align:center;">BTAO</h2>


<p style="text-align:center;">
   In this test it consists of test1 which consists of arithmetic & logic and test2 which consists of techinical questions and test3 which consists of general knowledge
</p>


      <div class="container">
  <h2  style="text-align:center;">Choose your test</h2><br>


  <a   style="margin-left:40%;" href="/civil/test1/mocktest1"type="button" class="btn btn-warning">test1</a><BR><br>
  <a   style="margin-left:40%;" href="/civil/test 2/mocktest2" type="button" class="btn btn-success">test2</a><br><br>
  <a  style="margin-left:40%;" href="/civil/test 3/mocktest3" type="button" class="btn btn-info">test3</a><br>
