...
<section>
  ...
  <div class="container" id="h" >
      <h2 class="heading" style="top:-10px; color:#005580;font-family:Cursive;">BTAO</h2>
...
<p style="font-family:;">
  ...
  <a   style="margin-left:40%;" href="/eee/test1/mocktest1"type="button" class="btn btn-warning">test1</a><BR><br>
  <a   style="margin-left:40%;" href="/eee/test 2/mocktest2" type="button" class="btn btn-success">test2</a><br><br>
  <a  style="margin-left:40%;" href="/eee/test 3/mocktest3" type="button" class="btn btn-info">test3</a><br>
