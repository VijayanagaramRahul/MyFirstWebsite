...
<div class="f">
         ...
         <label>Email </label>
        <input name="email" type="email" class="form-control" placeholder="Enter email" value="<?php echo @$_COOKIE['email']; ?>">
        <label>Enter Password</label>
         <input name="pass" type="password" class="form-control"  placeholder="Enter Password" value="<?php echo @$_COOKIE['pass']; ?>">
        <br>
